...
export class MainMenuUI extends Component {
    ...
    private _buildUI(): void {
        ...
        bgGfx.fillColor = new Color(20, 20, 40, 150);
        ...
        titleUt.setContentSize(new Size(600, 60));
        const titleLabel = titleNode.addComponent(Label);
        titleLabel.string = 'Kick!! the Brick...';
        ...
        subLabel.string = '3 Levels • Kick All Bricks!';
        ...
        blUt.setContentSize(new Size(220, 60));
